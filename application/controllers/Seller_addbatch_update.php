...
class Seller_addbatch_update extends CI_Controller {
	...
	public function index()
	{
		...
		//==================================================================
		$data2 = array('tenderid' => $sauctionid,'tenderer' => $sname, 'tslotno' => $slotno, 'batchname' => $slotname, 'category' => $scategory, 'batchdes' => $sdescription, 'batchreqqty' => $sqty,  'batchunits' => $sunitmeasurment, 'batchhsncode' => $shsncode);
		//$this->load->view('xya', $data);
		$datainserr = "Data Inserted Successfully";
		$updatech = array('tenderid' => $sauctionid ,'tslotno' => $slotno);
		$status = $this->Admin_model->update_custom('tender_batch',$data2,$updatech,$updatech);
		
		
			
		header('location: '.base_url().'/Seller_editforthcomtenders/index/'.$datainserr);
