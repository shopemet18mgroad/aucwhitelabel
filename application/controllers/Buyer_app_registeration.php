...
class Buyer_app_registeration extends CI_Controller {
    ...
    public function index(){
        ...
        if($this->input->post('submit2')){
            ...
            if($captcha === $sessCaptcha){
			  ...
			  if($status){
				  ...
				  redirect('../Buyer_app_agreement');
			  }else{
				   header('location: ./Buyer_app_registeration/error_handler/Database Insertion Error. Please Try Again');
			  }
            }else{
                header('location: ./Buyer_app_registeration/error_handler/Captcha Timed Out. Please Try Later');//echo 'Captcha code does not match, please try again.';
            }
        }
		...
		$this->load->view('buyer_app/buyersregisteration',$data);
