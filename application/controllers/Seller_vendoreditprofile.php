...
class Seller_vendoreditprofile extends CI_Controller {
	...
	public function index()
	{
		...
		if(count($data)){
			...
			foreach($data as $dat){
				...
				echo '<td data-label="Action"><a href="'.base_url().'seller_editbuyer/edit_buyer/'.$dat['bcompany'].'">';
				echo '<i class="fa fa-edit"></i>';
				echo '</a>';
				echo '<a href="'.base_url().'seller_editbuyer/delete_buyer/'.$dat['bcompany'].'" class="btn btn-sm text-white delete-confirm">';
				echo '<i class="fa fa-trash" style="color:black"></i>';
				echo '</a>';
				echo '<a href="'.base_url().'seller_vendoreditprofile/INACTIVE/'.$dat['bcompany'].'" class="btn btn-sm text-white ">';
				...
				echo '<a href="'.base_url().'seller_vendoreditprofile/Subscribed/'.$dat['bcompany'].'" class="btn btn-sm text-white ">';
				echo '<i class="fa fa-check-circle" aria-hidden="true"  style="color:green"></i>';
				echo '</a>';
				echo '<a href="'.base_url().'seller_vendoreditprofile/Unsubscribed/'.$dat['bcompany'].'" class="btn btn-sm text-white ">';
...
echo "</script>\n";
	...
	public function INACTIVE(){
		...
		header('location: '.base_url().'Seller_vendoreditprofile/index/');
		die;
	}
