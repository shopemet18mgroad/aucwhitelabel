...
class Seller_starttender_update extends CI_Controller {
	...
	public function index()
	{
		...
		//==================================================================
		$data2 = array('tenderstartdate' => $saucstartdate_time, 'tenderenddate' => $saucclosedate_time, 'tterms_condiaccept'=> $sterms_condiaccept, 'tterms_condiupload' => $doc_array,'ttermsandcond_own' => $sterms_text);
		//$this->load->view('xya', $data);
		$datainserr = "Data Inserted Successfully";
		$updatech = array('tenderid' => $sauctionid);
		$status = $this->Admin_model->update_custom('tender',$data2,$updatech,$updatech);
