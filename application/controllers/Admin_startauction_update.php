...
class Admin_startauction_update extends CI_Controller {
	...
	public function index()
	{
		...
		if(!count($result2) && !$_FILES['sterms_condiupload']['name']){
			...
			header('location: '.base_url().'admin_editauction/edit_auction_alert/'.$sauctionid.'/'.$datainserr);
		}
		...
		//==================================================================
		$data2 = array('scategory' => $scategory, 'sauctionid' => $sauctionid, 'sname' => $sname, 'svinspection' => $svinspection, 'sonlineaucdate_time' => $sonlineaucdate_time, 'sterms_condiaccept'=> $sterms_condiaccept, 'sterms_condiupload' => $pic_array1);
