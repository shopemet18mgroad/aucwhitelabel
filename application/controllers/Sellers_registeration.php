...
class Sellers_registeration extends CI_Controller
{
	...
	public function index()
	{
		...
		//The seller registration form is getting validated once the submit button is clicked.
		// 
		...
		// Loading the views from base_url/views(header,sellersregisteration,footer)
		$this->load->view('header2');
		$this->load->view('sellersregisteration', $data);
		$this->load->view('footer');
	}
//Funtion to validate companyname whther the company name exixsts or not
	...
	//Funtion for Validating the Gst number 
...
//validation of username 
	...
	//Error handling Function getting the uri segment 3 
	...
	{
		// Captcha configuration Validation  	
