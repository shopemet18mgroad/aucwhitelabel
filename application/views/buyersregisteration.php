...
?>
  ...
  <div class="card-header py-3 d-flex bg-info flex-row align-items-center justify-content-center">
    ...
    <tbody>
	  ...
	  <tr>
	  <td><b>E-Mail *</b></td>
	  <td><input  class="form-control w-75" type="text" id="bemail" name="bemail" size="50"></td>
	  </tr>
	  <tr>
	  <td><b>Phone No. *</b></td>
	  ...
	  <tr>
        <td><b>Password *</b></td>
        <td><input class="form-control w-75" type="password" id="bpassword" name="bpassword" size="50"></td>       
      </tr>
	  <tr>
	  ...
	  <tr>
		...
		<a href='agreementforbuyer.php'><button type="button" class="btn btn-primary offset-sm-1 mt-2">Proceed</button></a>
