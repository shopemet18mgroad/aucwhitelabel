...
?>
        ...
        <div class="container-fluid">
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
			  ...
			  <div class="form-group w-auto small">
		...
		<table class="table table-striped table-sm text-center table-bordered" id="dataTable" width="100%" cellspacing="0">
				...
				<tbody>
				<tr>												
					<td><a href="<?php echo base_url();?>admin_liveauc_2">EEMT/BBR/OMFED LTD/1/Shashi Nagar/99087/19-20</a></td>
				</tr>
				<tr>
					<td><a href="<?php echo base_url();?>admin_liveauc_2">BHEL/BBR/ISG LTD/2/Adarsh Vihar/25087/20-20</a></td>
				</tr>  
				<tr>
					<td><a href="<?php echo base_url();?>admin_liveauc_2">REMT/BBR/ONGC LTD/3/Tamil Nadu/Vellore Dist/465895/18-20</a></td>
				</tr>  
				<tr>												
					<td><a href="<?php echo base_url();?>admin_liveauc_2">HMT/BBR/Adnani logistic Ltd/4/Vidyut Nagar/99087/19-20</a></td>
				<tr>												
					<td><a href="<?php echo base_url();?>admin_liveauc_2">BEL/BBR/ONGC LTD/5/Nehru Nagar/99087/19-20</a></td>
				</tr>
				</tbody>
		 </table>
		</div>
