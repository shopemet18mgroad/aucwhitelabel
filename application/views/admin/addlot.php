...
font_formats:
	...
	<tr>
	  ...
	  <tr>
	   ...
	   <tr>
		  <td>Description</td>
		  <td><textarea class="form-control w-75" type="text" id="sdescription" name="sdescription" ></textarea>
	  </tr>
	  <tr>  												
		<td>Location Of Lot</td>
		<td><input class="form-control w-50" type="text" id="slotlocation" name="slotlocation">
		</td>
	</tr>
