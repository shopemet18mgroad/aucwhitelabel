...
font_formats:
    ...
    <thead class="bg-success text-white">
      <tr>
		<th colspan="10"><center>Add Batch</center></th>  
      </tr>
    </thead>
    <tbody>
	<form name="myForm" action="<?php echo base_url();?>seller_addbatch_info" method="POST" enctype="multipart/form-data">
	<tr>
		  <td>Tender Id</td>
	  ...
	  <tr>
		  ...
		  <td>Batch Name</td>
		  <td><input class="form-control w-100" type="text" id="slotname" name="slotname" ></td>
	  </tr>
	  <tr>
