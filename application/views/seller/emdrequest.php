...
<td><b><?php echo $sqldata->auctionid;?></b></td>
				...
				<a style="margin:2px" class="btn btn-danger btn-sm text-white" href="<?php echo base_url()."Seller_emdrequest/setdeactive_buyer_emd1/".$sqldata->lotno."/".$proid."/". $sqldata->bidderusername;?>"><i class="fa fa-trash"></i></a>
