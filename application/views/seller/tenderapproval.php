   	...
   	<?php if(isset($sqldatarec)){ foreach($sqldatarec as $sqldata){?>
		<?php /*  print_r($datareciver[4]); die;  */ ?>
					<tr>												
						...
						<td data-label="Action"><button type="submit" name="submit" id="<?php echo $sqldata[0]->sl_no; ?>" onclick="tenderee_set(this.id)" class="btn btn-info btn-sm">Approve</button></td>	
