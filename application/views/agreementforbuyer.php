            ...
            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                ...
                <div class="space w-100">
                    ...
                    <P class="para">This Agreement made this&nbsp; <span><b><?php echo $date; ?></b></span>&nbsp; day of
                        &nbsp;<span><b><?php echo $date; ?></b></span> Between
                        M/S &nbsp; <span><b><?php echo $company;?></b></span><br>having its Registered office at
                        <span><b><?php echo $address.", ".$city.", ".$pin.".";?></b><span> herein called “ Partner
                    ...
                    <p class="para">
                        ...
                        the lifter by a letter of authority on his own risk, The buyer will be held responsible for any
