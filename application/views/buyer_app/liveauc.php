          ...
          <div class="card shadow mb-4">
            <div class="card-body">
			 ...
			 <?php foreach ($sqldata as $sqldat){?>
					<tr>												
					<td data-label="Auction Id"><a href="<?php echo base_url()."Buyer_app_liveauc_2/index/".str_ireplace('/','-',$sqldat->auctionid);?>" data-toggle="modal" data-target="#myModal-<?php echo $count; ?>"><?php echo $sqldat->auctionid;?></a>
					</td>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
       <!-- <button type="button" class="btn btn-primary" data-dismiss="modal">OK</button>-->
		<a href="<?php echo base_url()."Buyer_app_liveauc_2/index/".str_ireplace('/','-',$sqldat->auctionid);?>" type="button" class="btn btn-primary" onclick="return validat()">OK</a>
      </div>
...
var contents = $('#ref').val(); 
		$.get('<?php echo base_url() .'Buyer_app_liveauc_2/get_table_ajax_liveauc_index/'; ?>', function(data){
			$('#liveauc').html(data);
});
