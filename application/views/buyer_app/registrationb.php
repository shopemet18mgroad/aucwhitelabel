...
particularly interested in the item/s being sold/bought on behalf of the seller/buyer.</br></br></p>

<p class="termstxt2">DEFINITIONS</p>
<p class="para">
<b>1. SELLER/BUYER - SELLER/BUYER</b> - Seller/Buyer referred to in this agreement is any real
...
<p class="para">
<b>2. BIDDER - </b> Any legal entity who is registered with AucJunction and who makes or places a
...
that Bidder in whose name the sale certificate or purchase order is issued by the Seller/Buyer.
</p>
<p class="para">
<b>3. PAID MEMBER - </b>Any Bidder who pays the annual membership fee as prescribed by
AucJunction is a paid member.
</p>

<p class="para">
<b>4. USER - </b>Any legal entity who uses the website and/or the related services provided by
AucJunction is considered as a User.
</p>

<p class="para">
<b>5. AGREEMENT - </b>The terms and conditions, together with any additional terms and conditions
specific to an online auction event on the website (which can be found through one or more
links on the website for the auction in question) constitute the Agreement.
</p>

<p class="para">
<b>6. ONLINE BIDDING EVENT - </b>An Online Bidding Event is a process for price determination
...
<p class="para">
<b>7. </b>On accessing the website or using the services provided by AucJunction or by registering
either as a Buyer/ Seller / User you agree that you have read the General Terms and
Conditions, including the terms and conditions specific to an online auction event.</
</p>

<p class="para">
<b>8. </b>You are bound by these terms and conditions, including those specific to a particular online
auction event
</p>
<p class="termstxt2">MODIFICATIONS TO WEBSITE, SERVICES AND TERMS AND CONDITIONS</p>
...
<p class="termstxt2">PASSWORD AND SECURITY</p>
<p class="para">
...
use and for maintaining and protecting the confidentiality of their User ID and password
</p>

<p class="termstxt2">FORGOT PASSWORD</p>
<p class="para">
...
verification code, you can change your log in password.
</p>

<p class="termstxt2">TRANSACTION PASSWORD</p>
<p class="para">
...
number and their registered e-mail ID. Transaction password is session specific.
</p>

<p class="termstxt2">TIME</p>
<p class="para">
...
<p class="termstxt2">TERMS OF AGREEMENT</p>
<p class="para">
...
<p class="termstxt2">1.0 GENERAL TERMS AND CONDITIONS</p>
<p class="para">
<b>1.1 </b>Participation and bidding in the auctions on the website shall be treated as
...
No objections or complaints will be entertained once the bid is placed.
</p>

<p class="para">
<b>1.2 </b>All assets sold/bought on the website are on &quot;AS IS WHERE IS BASIS&quot; and &quot;NO
COMPLAINT BASIS&quot;.
</p>

<p class="para">
<b>1.3 </b>AucJunction does not give warranty or guarantee of the quality, quantity,
measurement, condition, and chemical composition of the assets and about its &quot;End
Use&quot; or fitness for a particular purpose.
</p>

<p class="para">
<b>1.4 </b>The highest/lowest Bidder does not get any right to demand acceptance of his
...
<p class="termstxt2">2.0 COMMUNICATION</p>
<p class="para">
<b>2.1 </b>User consents to receive communication from AucJunction by electronic mail, short
...
their registration on the NDNC, if any.
</p>

<p class="para">
<b>2.2 </b>Only Paid Members will be able to download the Auction Catalog from the website after
logging into the website.
</p>
<p class="termstxt2">3.0 ONLINE BIDDING</p>

<p class="para">
<b>3.1 Multiple Log in from same IP Address - </b>Bidders participating in the auctions may please
note that multiple login from the same IP Address will not be permitted.
</p>

<p class="para">
<b>3.2 Time Extension - </b>If any market-leading bid (bid higher/lower than the highest/lowest at the
...
bidding room will apply and three minutes is only an example.
</p>

<p class="para">
<b>3.3 Bids - </b>All bids placed are legally valid bids and are to be considered as bids from the Bidder
...
that of an auto bid, the manual bid will prevail and be considered.
</p>


<p class="termstxt2">3.4 Auto Bid:</p>
<p class="para">
<b>a. </b>Auto Bid facility is provided for bidders intending to place a maximum/minimum value for a
lot/lots.
</p>
<p class="para">
<b>b. </b>Auto Bid is not a confirmed bid. It is only the maximum ceiling amount/minimum floor amount
set by the bidder to enable the auction engine to place bids on his behalf, whenever he is
outbid, up to the ceiling/floor amount set by him.
</p>

<p class="para">
<b>c. </b>Once an Auto Bid is set, the auction engine will consider the ceiling/floor amount for the next
...
<p class="para">
<b>d.</b> Bidders may please note that in the event of a manual bid amount matching that of an Auto
Bid, the manual bid will prevail and be considered.
</p>

<p class="termstxt2">4.0 TERMINATION</p>
<p class="para">
<b>4.1 </b>- AucJunction expressly reserves the right to terminate the use of, or to refuse to permit the
use of, the Services and the Website by any person or entity, at the sole discretion of
AucJunction, for any reason and without notice.
</p>

<p class="termstxt2">5.0 FORCE MAJEURE</p>
<p class="para">
<b>5.1 </b> AucJunction shall not be liable for any failure or delay in performance due to any cause
...
operate to extend the time of performance till the cause of delay shall have ceased to exist.
</p>

<p class="termstxt2">6.0 DISCLAIMER</p>
<p class="para">
<b>6.1 </b>  AucJunction runs its business on the basis of a robust website. AucJunction is outsourcing
...
<p class="para">
<b>6.2</b> AucJunction takes no responsibility of the quality, quantity, documentation details of
...
the Seller/Buyer and the Bidder.
</p>
<p class="para">
<b>6.3 </b>The Seller/Bidder agrees to limit the liability of Shopemet Networks Pvt. Ltd. to them for any,
...
<p class="para">
<b>6.4 </b> Terms &amp; conditions as laid down by the auctioneer shall apply in addition.
</p>
<p class="para">
<b>6.5 </b> The logos displayed above are the registered trademarks of companies who have used the
...
representation or warranty, express or implied, is made by AucJunction.
</p>
<p class="termstxt2">7.0 GOVERNING LAW AND JURISDICTION</p>
<p class="para">
<b>7.1 </b> This agreement is governed and construed in accordance with the laws of the Union of
...
<p class="para">
<b>7.2 </b> Users agree to indemnify and hold AucJunction and its officials and employees harmless
from any claim, demand or damage asserted by any third party due to and arising out of use of
services and the website.
</p>
<p class="termstxt2">GST</p>
<p class="para">
 ...
 <div class="form-check para">
    ...
    <label class="form-check-label" for="agreement">I have read and agree with the terms and conditions. </label>
			...
			<div class="text-center" style="position:relative;">
				<button  type="button" class="btn btn-primary mt-2" href="<?php echo base_url();?>index" onclick="return validate_regb()">Agree</button>
