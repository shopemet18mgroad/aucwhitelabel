...
<link href="<?php echo base_url()."web_files/";?>css/tablestyle.css" rel="stylesheet" type="text/css">
        ...
        <div class="container-fluid">
          ...
          <div class="d-sm-flex align-items-center justify-content-between mb-4">
            <h2 class="h3 mb-0 text-gray-800">Live Tender</h2>
          ...
          <div class="card shadow mb-4">
            <div class="card-body">
			  ...
			  <table class="table table-striped table-sm text-center table-bordered " id="dataTable" width="100%" cellspacing="0">
				...
				<tr>
					<th width="60%">Click for Tender</th>
					<th>Tenderer Name</th>
			 ...
			 <?php foreach ($sqldata as $sqldat){?>
					<tr>												
					<td data-label="Tender Id"><a href="<?php echo base_url()."Buyer_livetend_2/index/".str_ireplace('/','-',$sqldat->tenderid);?>" data-toggle="modal" data-target="#myModal-<?php echo $count; ?>"><?php echo $sqldat->tenderid;?></a>
					</td>
					<td data-label="Tenderer"><?php echo $sqldat->sname; ?></td>
					</tr>
							 <!-- The Modal -->
  ...
  <div class="modal-dialog">
    <div class="modal-content">
	  ...
	  <div class="form-check form-check-inline">
        ...
        <p><?php echo $sqldat->tenderdesc; ?></p>
      ...
      <div class="modal-footer">
       <!-- <button type="button" class="btn btn-primary" data-dismiss="modal">OK</button>-->
		<a href="<?php echo base_url()."Buyer_livetend_2/index/".str_ireplace('/','-',$sqldat->tenderid);?>" type="button" class="btn btn-primary" onclick="return validat()">OK</a>
      </div>
...
var contents = $('#ref').val(); 
		$.get('<?php echo base_url() .'Buyer_livetend_2/get_table_ajax_liveauc_index/'; ?>', function(data){
