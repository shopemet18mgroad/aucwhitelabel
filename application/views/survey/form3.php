									...
									<div class="table-holder"> 
										<div class="tab-content">
											<table class="table table-bordered table-sm">
												...
												<td>
												<div class="cinpt">
												<p><b>Primary industry or line of business at this location? What is the principal product or service at this location? Please tell me which<br> of the following Products/Materials do you typically procure/sell depending on day to day operations?<br></b></p>
												<div class="form-check form-check-inline ">
												...
												<p><b>Others,pls specify:</b><input class="inpt w-100" type="text" id="princprodcon" name="princprodcon" size="70"></p>
												</div>	
												</td>
												</tr>
												...
												<td>
												<div class="cinpt">
												<p><b>Are you importing any product category’s from outside India, if yes what product? Country imported?</b><br>
												...
												<td>
												<div class="cinpt">
												<p><b>What is the approximate time taken to clear the stock/how fast is stock cleared, once you get a lot in
												your gowrdon?</b><br>
												...
												<td>
												<div class="cinpt">
												<p><b>Is transportaion free of cost or chargeable? is it with Karnataka, only with south India or Pan India
												transportation<br></b>
												...
												<td>
												<div class="cinpt">
												<p><b>How fast can you dispatch the order once the order placed ? within 24h, 48h, 72h, or one week<br></b>
												...
												<td>
												<div class="cinpt">
												<p><b>Do you have any kind of “CAP”while placing every order, like minimum order should by “5” Tons,
												”1000” KG, so on? if yes please<br> specify<br></b>
												...
												<td>	
												<div class="cinpt">
												<p><b>If required, can you provide documentation for material/testing conformance to applicable specifications
												(e.g., material<br> certifications, quality certificates of conformance/complice LAB test)?<br></b></p>
												...
												<td>
												<div class="cinpt">
												<p><b>Is there a system in place to review, promtly resolve, take corrective/preventive action for customer
												complaints?<br></b></p>
												...
												<td>
												<div class="cinpt">
												<p><b>Payment Terms, Credit period for industries against PDC:</b>
												
												<input class="inpt w-100" type="text" id="paymentterms" name="paymentterms" size="50"></p>
												<p>
												<b>Annual sales(turnover):</b>
												...
												<td>
												<div class="cinpt">
												<p><b>Finally thanking you for your valuable feedback, Please feel free to share any suggestions, challenges
												faced in Raw-Materials<br> buying and selling ?<br></b>
												...
												<td colspan="10">
												<div class="cinpt">
												<p><b>We are going to launch<a href="www.rawmet24.com"> www.rawmet24.com</a> competitors and target all buyers across India, ware in you can get
												...
												time.</b></p>
													...
													<a href="#"><button type="submit" name="submit" onclick="return validateforms()"id="submit" class="btn btn-primary" >Submit</button></a>
