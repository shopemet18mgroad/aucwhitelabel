...
<head>
  ...
  <link href="<?php echo base_url()."web_files/";?>css/form-style.css" rel="stylesheet" type="text/css">
		...
		<div class="row">
				<div class="col-md-12 contact-header">
					<div class="social-dash pull-right">
						<ul>
							<li><a href="<?php echo base_url();?>survey_dashboard"><i class="fa fa-arrow-left" aria-hidden="true"></i>&nbsp Back</a></li>
							<li><a href="<?php echo base_url();?>weblib/logout.php"><i class="fa fa-sign-out" aria-hidden="true"></i>&nbsp Logout</a></li>
						</ul>
					</div>		
				</div>
