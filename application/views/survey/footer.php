<section id="footer">
			...
			<div class="row">
				<div class="col-xs-12 col-sm-12 col-md-12 mt-2 mt-sm-1">
					<ul class="list-unstyled list-inline social text-center">
						...
						<li class="list-inline-item mr-5"><a href="" target="_blank"><i class="fa fa-envelope"></i></a></li>
					</ul>
				</div>
				<hr>
			</div>	
  ...
  <script src="<?php echo base_url()."web_files/";?>js/jquery-3.2.2.js"></script>
  ...
  <script src="<?php echo base_url()."web_files/";?>js/jquery.autoscroll.js" type="text/javascript" charset="utf-8"></script>
